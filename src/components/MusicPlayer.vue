...
<template>
    <div class="player">
        <div class="now-playing">
            ...
            <div>
                <div class="like-icon text-red-400" v-if="playlist.tracks.includes(player.currentTrack)" @click="user.unlikeSong(playlist.tracks.indexOf(player.currentTrack), 1)">
        ...
        <div class="controls">
            <div class="buttons">
                ...
                <div class="playpause-button">
                    <PlayIcon width="45" height="45" class=" text-amber-800" @click="play" v-if="audio && !player.playing" />
                    <PauseIcon width="45" height="45" class=" text-amber-800" @click="play" v-else  />
                </div>
